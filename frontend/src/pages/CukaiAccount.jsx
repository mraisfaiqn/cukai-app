...
const INITIAL_DOCS = [
  { id: 1, name: 'Invoice_May2026_001.pdf', type: 'Invoice', fileType: 'pdf', date: '12 May 2026', amount: 'RM 8,400', status: 'deductible', category: 'Sales & Service Income', note: 'Client invoice for design retainer.',
  ...
  { id: 17, name: 'Invoice_Dec2020_088.pdf', type: 'Invoice', fileType: 'pdf', date: '14 Dec 2020', amount: 'RM 6,150', status: 'deductible', category: 'Sales & Service Income', note: 'Year-end client invoice.',
    vendor: 'Meridian Print Studio', vendorAddr: 'Lot 5, Jalan Industri 2, 40000 Shah Alam, Selangor', docNo: 'INV-2020-1214', accent: '#0F6E56', confidence: 85,
    lineItems: [{ desc: 'Annual report design and print — Dec 2020', amt: 6150.00 }] },
  { id: 18, name: 'Receipt_Utilities_Mar2021.pdf', type: 'Utility Bill', fileType: 'pdf', date: '28 Mar 2021', amount: 'RM 980', status: 'deductible', category: 'Rental & Utilities', note: 'TNB electricity bill — office premise.',
    vendor: 'Tenaga Nasional Berhad', vendorAddr: 'No. 129, Jalan Bangsar, 59200 Kuala Lumpur', docNo: 'TNB-31204471', accent: '#10B981', confidence: 93,
    lineItems: [{ desc: 'Electricity usage — February 2021', amt: 980.00 }] },
  { id: 19, name: 'Office_Renovation_Sept2022.pdf', type: 'Invoice', fileType: 'pdf', date: '9 Sep 2022', amount: 'RM 12,400', status: 'deductible', category: 'Capital Assets & Equipment', note: 'Office renovation — capital improvement.',
    vendor: 'BuildRight Renovations', vendorAddr: 'No. 17, Jalan Industri 4, 40000 Shah Alam, Selangor', docNo: 'BR-2022-0909', accent: '#0369A1', confidence: 78,
    lineItems: [{ desc: 'Office partition and flooring works', amt: 9400.00 }, { desc: 'Electrical rewiring', amt: 3000.00 }] },
  { id: 20, name: 'Family_Medical_Bill_2023.jpg', type: 'Receipt', fileType: 'image', date: '3 Mar 2023', amount: 'RM 1,250', status: 'non_deductible', category: 'Medical & Healthcare', note: 'Family medical expenses — personal.',
    vendor: 'Pantai Hospital', vendorAddr: 'Jalan Bukit Pantai, 59100 Kuala Lumpur', docNo: 'PH-OPD-22301', accent: '#DC2626', confidence: 91,
    lineItems: [{ desc: 'Outpatient consultation and medication', amt: 1250.00 }] },
  { id: 21, name: 'Supplier_Paper_Stock_2024.pdf', type: 'Purchase Order', fileType: 'pdf', date: '19 Jul 2024', amount: 'RM 4,820', status: 'deductible', category: 'Supplier & Inventory Purchases', note: 'Bulk paper stock for print jobs.',
    vendor: 'PaperWorks Trading Sdn Bhd', vendorAddr: 'No. 8, Jalan Perusahaan 2, 47100 Puchong, Selangor', docNo: 'PO-2024-3381', accent: '#0D9488', confidence: 89,
  ...
  { id: 22, name: 'Annual_Insurance_Premium_2025.pdf', type: 'Invoice', fileType: 'pdf', date: '11 Feb 2025', amount: 'RM 2,160', status: 'mixed', category: REVIEW_CATEGORY,
    ...
    vendor: 'Allianz General Insurance Malaysia', vendorAddr: 'Level 29, Menara Allianz Sentral, 50470 Kuala Lumpur', docNo: 'ALZ-2025-0211', accent: '#F59E0B',
