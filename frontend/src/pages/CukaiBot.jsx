        ...
        {embed && (
          <div className="shrink-0 flex items-center justify-between gap-2">
            ...
            <button
              ...
              className="inline-flex shrink-0 items-center gap-1 rounded-lg border border-border bg-surface px-2.5 py-1 text-xs font-semibold text-muted transition-colors hover:border-primary hover:text-primary"
            >
              <PlusIcon className="h-3.5 w-3.5" />
              New chat
            </button>
